...
if menu == "🔍 Análisis de empresa":
   ...
   # Usando on_change o submit para ejecutar al presionar Enter
   ticker_input = st.text_input("🔍 Escribe el símbolo bursátil (Ej. AAPL, MSFT, TSLA...) y presiona Enter:", 
                                placeholder="Ej. AAPL",
                                key="ticker_input")
   periodo = st.selectbox("🕒 Periodo a analizar:", ["6mo", "1y", "5y", "max"], index=0)

   # Comprobar si hay algún valor en el campo al presionar Enter
